    ...
    const roleConfigs: Array<{ slug: string; name: string; permissions: string[] }> = [
      ...
      { slug: 'admin',       name: 'Administrador',       permissions: allCodes },
      {
        ...
        permissions: [
          ...
          PERMISSIONS.TICKET_EDIT, PERMISSIONS.TICKET_EDIT_CONTENT, PERMISSIONS.TICKET_REPLY, PERMISSIONS.TICKET_TRANSFER,
      ...
      },
      {
        ...
        permissions: [
          PERMISSIONS.DASHBOARD_VIEW, PERMISSIONS.TICKET_VIEW, PERMISSIONS.TICKET_CREATE,
          PERMISSIONS.TICKET_EDIT, PERMISSIONS.TICKET_EDIT_CONTENT, PERMISSIONS.TICKET_REPLY, PERMISSIONS.TICKET_CLOSE,
