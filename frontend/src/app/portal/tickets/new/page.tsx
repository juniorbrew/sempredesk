  ...
  return (
    <div style={{ maxWidth:700 }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:24 }}>
        <Link href="/portal/tickets" style={{ display:'flex', alignItems:'center', justifyContent:'center', width:36, height:36, background:'#fff', border:'1.5px solid #E2E8F0', borderRadius:10, color:'#475569', textDecoration:'none' }}>
      ...
      <form onSubmit={onSubmit} style={{ display:'flex', flexDirection:'column', gap:16 }}>
        ...
        <div style={{ display:'flex', justifyContent:'flex-end', gap:12 }}>
          <Link href="/portal/tickets" style={{ padding:'10px 20px', background:'#fff', border:'1.5px solid #E2E8F0', borderRadius:10, color:'#475569', fontSize:14, fontWeight:600, textDecoration:'none', display:'inline-flex', alignItems:'center' }}>
            Cancelar
          </Link>
